...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast.error(err?.response?.data?.error?.message || err.message || "Google Login failed");
      setIsLoading(false);
    }
  };
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Button
                  ...
                  disabled={isLoading}
                  variant="outline"
                  className="w-full border-2 border-slate-900 dark:border-slate-100 rounded-none font-bold shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] dark:shadow-[4px_4px_0px_0px_rgba(241,245,249,1)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_rgba(15,23,42,1)] dark:hover:shadow-[6px_6px_0px_0px_rgba(241,245,249,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_rgba(15,23,42,1)] dark:active:shadow-[1px_1px_0px_0px_rgba(241,245,249,1)] transition-all flex items-center justify-center gap-2 h-11"
                >
